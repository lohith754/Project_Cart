class GalleryController < ApplicationController
  ...
  def search
    ...
    @search_results= Estore.find_by_sql ["Select * from estores WHERE name like ? or brand like ? or material like ? ",keyword,keyword,keyword]
  end
end
